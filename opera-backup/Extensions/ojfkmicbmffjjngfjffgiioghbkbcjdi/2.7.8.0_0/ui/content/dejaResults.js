...
DejaClickUi.Results = function (aUtils, aConstants, aGetScript,
   ...
   this.elements.resultsData.css("visibility", "visible");
   this.elements.resultsPending.css("visibility", "visible");
};
      ...
      try {
         ...
         if (category != 'none') {
            if ( this.results[category] )
               ...
               console.log("No results available for category: "+category);
         }
      } catch (ex) {
         this.logger.logException(ex);
      }
