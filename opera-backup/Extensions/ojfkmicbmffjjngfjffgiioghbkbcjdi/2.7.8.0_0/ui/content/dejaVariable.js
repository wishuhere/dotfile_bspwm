...
DejaClickUi.Variable.prototype = {
   ...
   init: function (aOptions) {
      ...
      try {
         if (this.item == null) {
            ...
            DejaClick.service.__modal.setTitle('deja_variables_title_add');
            ...
            DejaClick.service.__modal.setTitle('deja_variables_title_edit');
   ...
   preview: function (aEvent) {
      ...
      try {
         ...
         this.variableUtils.computeScriptVariableForPreview(
            tokens,
