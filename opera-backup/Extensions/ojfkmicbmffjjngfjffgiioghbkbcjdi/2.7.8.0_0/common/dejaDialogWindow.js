...
DejaClick.DialogWindow = function (aUrl, opt_argument, opt_createdCb,
   ...
   url = chrome.runtime.getURL(aUrl);

   if(DejaClick && DejaClick.service && DejaClick.service.__modal){
      return DejaClick.service.__modal.openModal(url,opt_argument,opt_createdCb,opt_closedCb);
   }
         ...
         if ( typeof browser !== "undefined" ) {
            ...
            windowOpts.focused = true;
         }

         this.m_windows.create(windowOpts, 
...
DejaClick.DialogWindow.prototype = {
   ...
   centerOnWindow: function (aWindow, aWidth, aHeight) {
      ...
      if (navigator && navigator.platform.indexOf('Mac') === -1) {
            left = (left < 0) ? 0 : left;
            top = (top < 0) ? 0 : top;
      }
      top = Math.floor(top);
      ...
      try {
         ...
         if (this.m_positioned) {
            ...
            dockFunc.call(this, opt_window,
               this.m_view[this.WIDTH], this.m_view.outerHeight);
   ...
   setWindow: function (aUrl, aArgument, aCreatedCb,
      ...
      try {
         ...
         if ( typeof browser !== "undefined" ) {
            //TODO Firefox Quantum UXM-11026
            // this.m_tabId is null in Firefox Quantum
         } else if (this.m_tabId == null) {
   ...
   endDialog: function (aWindowId) {
      ...
      try {
         if (aWindowId === this.m_windowId) {
            ...
            //Firefox Quantum UXM-11026 - Trying to access "this.m_view" generates "can't access dead object" error
            if ( typeof browser !== "undefined" ) {
               value = null;
            } else {
               value = (this.m_view) ? this.m_view.returnValue : null;
            }
            callback = this.m_callback;
            this.m_windowId = null;
            this.close();
