...
DejaClickUi.Options = function (aUtils, aConstants, aGetScript,
   ...
   this.buttonClasses = 'ui-button ui-widget ui-state-default ui-corner-all';
   ...
   this.elements.generalButton.button({ icons: { primary: 'general-icon' }, classes: {'ui-button': this.buttonClasses} });
   this.elements.recordButton.button({ icons: { primary: 'record-icon' }, classes: {'ui-button': this.buttonClasses}});
   this.elements.replayButton.button({ icons: { primary: 'replay-icon' }, classes: {'ui-button': this.buttonClasses} });
   ...
   if ( typeof browser !== "undefined" ) {
      $(this.elements.recordFrame).ready(this.initRecordFrame.bind(this));
      $(this.elements.replayFrame).ready(this.initReplayFrame.bind(this));
