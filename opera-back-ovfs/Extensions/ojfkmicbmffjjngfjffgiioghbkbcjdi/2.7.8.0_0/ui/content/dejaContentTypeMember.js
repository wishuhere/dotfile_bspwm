...
DejaClickUi.ContentTypeMember.prototype = {
   ...
   init: function () {
      try {
         if (this.item == null) {
            DejaClick.service.__modal.setTitle('deja_contentTypeMember_title_add');
            this.elements.description.text(this.utils.getMessage(
                  'deja_contentTypeMember_description_add'));
         } else {
            
            DejaClick.service.__modal.setTitle('deja_contentTypeMember_title_edit');
            this.elements.description.text(this.utils.getMessage(
   ...
   apply: function (aEvent) {
      ...
      try {
         ...
         DejaClick.service.__modal.close(this.elements.contentType.val() || null);
         this.close();
