...
DejaClick.Script.prototype = {
    ...
    */
   renumberElements: function (aTag) {
      var elements, length, index;

      elements = this.m_scriptElement.getElementsByTagName(aTag);
   ...
   createScript: function (domImpl) {
      ...
      this.domTreeAddAttribute(this.m_scriptElement, 'scripttype', 'DejaClick for Chrome');
      return this;
   },
   ...
   SUPPORTED_FEATURES: {focus: true, encryption: true, variables : true, "elementpath variables" : true, "script variables" : true, mobile : true, branching : true},
