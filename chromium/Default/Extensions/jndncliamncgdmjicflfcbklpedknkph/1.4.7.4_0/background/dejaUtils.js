...
DejaClick.Utils = function (aServer, aRuntime, aI18n, aCookies,
   ...
   this.prefService.
      ...
      define('DC_OPTID_APPENDMODE', constants.DC_APPENDMODE_DEFAULT, new IntType(constants.DC_APPENDMODE_DEFAULT, constants.DC_APPENDMODE_INSERT), 'appendmode').
 ...
 */
DejaClick.Utils.prototype.compareVersions = function (v1, v2) {
